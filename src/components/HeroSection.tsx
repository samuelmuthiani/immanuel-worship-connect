      ...
      {cmsContent ? (
        ...
        <>
          <div
            ...
            style={{
              backgroundImage:
                'linear-gradient(rgba(0, 0, 0, 0.5), rgba(0, 0, 0, 0.7)), url("https://images.unsplash.com/photo-1510425865936-0a352b16583f?ixlib=rb-4.0.3&q=80&w=1600&auto=format&fit=crop")',
            }}
          ></div>
